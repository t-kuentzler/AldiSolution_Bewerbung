...
public class ReceivingReturnPackagesResponseValidator : AbstractValidator<ReceivingReturnPackagesResponse>
{
    public ReceivingReturnPackagesResponseValidator()
    {
        RuleFor(r => r.status)
