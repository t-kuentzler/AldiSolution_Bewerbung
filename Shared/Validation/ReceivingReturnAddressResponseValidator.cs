...
namespace AldiOrderManagement.Validation;

public class ReceivingReturnAddressResponseValidator : AbstractValidator<ReceivingReturnAddressResponse>
{
    public ReceivingReturnAddressResponseValidator()
    {
