...
public class ReceivingReturnEntriesRequestValidator : AbstractValidator<ReceivingReturnEntriesRequest>
{
    public ReceivingReturnEntriesRequestValidator()
    {
        RuleFor(r => r.reason)
        ...
        RuleForEach(x => x.consignments).SetValidator(new ReceivingReturnConsignmentsRequestValidator());
    }
}